...
parametros = ["iter:100,pop:20","iter:200,pop:20","iter:300,pop:20","iter:400,pop:20","iter:500,pop:20"]
...
for instancia in instancias:
    ...
    archivoResumenFitness = open(f'{dirResultado}resumen_fitness_{problema}.csv', 'w')
    archivoResumenPercentage = open(f'{dirResultado}resumen_percentage_{problema}.csv', 'w')
    ...
    for d in blob:
        ...
        if graficos:
            ...
            plt.close('all')
            print(f'Grafico de diversidad realizado para {mh}, problema: {problem}')
    ...
    figFitness.savefig(dirResultado+"/boxplot/boxplot_fitness_"+problema+'.pdf')
    plt.close('all')
    ...
    axFitness.set_ylabel("Fitness")
    axFitness.set_xlabel("Metaheuristics")
    figFitness.savefig(dirResultado+"/violinplot/violinplot_fitness_"+problema+'.pdf')
    plt.close('all')
    ...
    axFitness.set_xlabel("Metaheuristics")
    figFitness.savefig(dirResultado+"/boxplot/boxplot_accuracy_"+problema+'.pdf')
    plt.close('all')
    ...
    axFitness.set_ylabel("Accuracy")
    axFitness.set_xlabel("Metaheuristics")
    figFitness.savefig(dirResultado+"/violinplot/violinplot_accuracy_"+problema+'.pdf')
    plt.close('all')
    ...
    axFitness.set_xlabel("Metaheuristics")
    figFitness.savefig(dirResultado+"/boxplot/boxplot_mcc_"+problema+'.pdf')
    plt.close('all')
    ...
    axFitness.set_ylabel("Matthew’s correlation coefficients")
    axFitness.set_xlabel("Metaheuristics")
    figFitness.savefig(dirResultado+"/violinplot/violinplot_mcc_"+problema+'.pdf')
    plt.close('all')
