...
def solverFS(id, mh, maxIter, pop, instancia, ds, clasificador, parametrosC):
    ...
    poblacion = np.ones(shape = (pop,instance.getTotalFeature()))
    # poblacion = util.generacionMixtaFS(pop, instance.getTotalFeature())
