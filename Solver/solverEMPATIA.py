...
def solverEMPATIA(id, mh, maxIter, pop, ds, instancia, param):
    ...
    if instancia == 'EMPATIA-9' or instancia == 'EMPATIA-10':
        loader.dataset = loader.exclude_volunteers([1,3,4,10,11,13,16,24,25,26,28,29,31,35,36,38,42,46,49,51,52,53,56,59,62,68,70,71,75,79,81,83,93,95,103,104,108,113])
