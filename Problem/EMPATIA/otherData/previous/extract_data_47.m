clear all;
clc;
load('Feats_BBDDLab_EH_47_W20s_noSolapadas.mat');
load('LabelsBBDDLab_74.mat');
%table_labels = info_bbddlab_wemac.labels;%original script
table_labels = LabelsBBDDLab_47;%modified for 47 bbdd lab
info_bbddlab_wemac = Feats_BBDDLab_EH_47_20wNOov;%modified for 47 bbdd lab
...
row=1;
data_volunt = [];
for v = 1:47 %num volunteers
    for t = 1:14 %num videos
        label=[];
